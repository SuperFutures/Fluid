...
//            jointPosition.y - offsetPos.y + kinectManager.sensorHeight,  //!! this should be better investigated .. 
    ...
    void Update()
    {   Vector3 rightPos= GetJointWorldPos(KinectInterop.JointType.HandRight);
        Righthand.transform.position= new Vector3(rightPos.x, rightPos.y, 0);

        Vector3 leftPos = GetJointWorldPos(KinectInterop.JointType.HandLeft);
        Lefthand.transform.position = new Vector3(leftPos.x, leftPos.y, 0);
